...
gr.raw.log <- log10(gr.data[,2:19]+0.001)
...
p.plot <- plot(jitter(rep(1, dim(gr.raw.data.rank)[1]), amount = 0.1), 
               gr.raw.data.rank[,2], ylim = c(0.00001, 5), xlim = c(-2, 39), log = "y",
               pch = 21, col = "lightgrey", bg = "lightgrey", lwd = 2, cex = 1.7, 
               yaxt = "n", xaxt = "n", cex.lab = 2, cex.axis = 1.5, las = 1, ylab = "", xlab = "")

box(lwd = 2)

for(i in 3:19) {
  points(gr.raw.data.rank$j, gr.raw.data.rank[[i]], pch = 21, bg = "lightgrey", col = "lightgrey", lwd = 2, cex = 1.7)
}
